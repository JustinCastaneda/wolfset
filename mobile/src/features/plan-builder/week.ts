// The Suggested Week on Plan Summary (Figma 123:2530): three sessions a week — Mon,
// Wed, Fri — cycling through the plan's days by letter. Two days → A B A; three → A B C;
// one → A A A. A suggestion only; nothing is scheduled yet. Pure — tested.
